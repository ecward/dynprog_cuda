...
int main(int argc, char **argv)
{
    ...
    int initial_v_idx = 0;//10; //12.5 m/s
    int n_times = 10;
    ...
    std::cout << "MAX runtime cpu: " << *std::max_element(cpu_runtimes.begin(), cpu_runtimes.end()) << std::endl;
    std::cout << "MIN runtime cpu: " << *std::min_element(cpu_runtimes.begin(), cpu_runtimes.end()) << std::endl;
    std::cout << "MEAN runtime gpu: " << std::accumulate(gpu_runtimes.begin(), gpu_runtimes.end(), 0.0)/10.0 << std::endl;
    std::cout << "MAX runtime gpu: " << *std::max_element(gpu_runtimes.begin(), gpu_runtimes.end()) << std::endl;
    std::cout << "MIN runtime gpu: " << *std::min_element(gpu_runtimes.begin(), gpu_runtimes.end()) << std::endl;
